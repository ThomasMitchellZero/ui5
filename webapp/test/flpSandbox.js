					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "HI Project Tracker",
									"targetURL": "#hipthipt-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"hipthipt-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hipt.hipt",
									"url": sap.ui.require.toUrl("hipt/hipt")
								}
							}
						}
					}
